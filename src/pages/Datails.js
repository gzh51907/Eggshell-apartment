...
class Datails extends Component {
    ...
    async componentDidMount() {
        ...
        let { goodslis: { data: datas }
        } = await goodslis
        // let wer = pathname.split("/")[2];
        ...
        let ododo = datas.filter(item => params.id == item._id)
        this.setState({
            ododo
        })
    }
            ...
            <div style={{ position: "relative" }}>
               ...
               <Carousel autoplay className="lunbo">
                ...
                <div style={{ width: "100%", height: "50px", position: "fixed", bottom: 0, left: 0, zIndex: 9 }} className="aaa">
                    <p className="p1" style={{ width: "20%", height: "100%", border: "1px solid #fff", fontSize: "10px" }}><Icon type="heart" style={{ display: "block", fontSize: "16px", background: "#fff" }} />收藏</p>
...
Datails = connect(mepStareprops)(Datails)
